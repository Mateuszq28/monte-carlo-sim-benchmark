...
data1 = np.full((180, 180), 128)  # Tablica 180x180 na płaszczyznę XY
data1[0:40, 0:40] = 0
data1[-40:-1, -40:-1] = 255
# data2 = np.random.rand(24, 18)  # Tablica 240x180 na płaszczyznę ZX
data2 = np.full((240, 180), 128)  # Tablica 240x180 na płaszczyznę ZX
data2[0:40, 0:40] = 0
data2[-40:-1, -40:-1] = 255
# data3 = np.random.rand(18, 24)  # Tablica 240x180 na płaszczyznę ZY
data3 = np.full((180, 240), 128)  # Tablica 240x180 na płaszczyznę ZY
data3[0:40, 0:40] = 0
data3[-40:-1, -40:-1] = 255
